...
#                 associated with "parallels"  (think y-axis)
#    Longitude := lines running pole-to-pole (East-West)
#                 associated with "meridians" (think x-axis)
...
# grad_map2 <- merge(mw_map, college.grad)
...
#=======================================================================
# CARTOGRAPHIC MAPS
# NOTE:  Now need to have an API google to use these functions with 
#        Google
